...
But if you've hit the same walls I did: `request: Request` everywhere, header injection forcing `Response` returns, no clean way to separate anonymous and authenticated limits, then fastlimit is what I wished existed when I was fighting with those problems.
