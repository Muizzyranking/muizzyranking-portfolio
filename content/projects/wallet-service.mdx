...
Paystack retries webhook delivery if it doesn't receive a timely response. That's normal behavior, but it becomes dangerous in a financial system. Without protection, a single payment could credit a wallet two or three times.
