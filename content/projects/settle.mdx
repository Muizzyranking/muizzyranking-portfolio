...
summary: "A virtual-account payment collection platform built on Nomba's APIs — automatic per-customer reconciliation, calendar-correct recurring billing, and a developer API the dashboard itself runs on."
