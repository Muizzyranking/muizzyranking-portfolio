...
Image uploads and email notifications were blocking API responses. On a slow connection, uploading a product image could hold the request open for several seconds. That's unacceptable for a supplier managing a catalog of dozens of products.
...
I also stepped into an acting lead role for roughly 8 weeks when the engineering lead left mid-project. I reviewed PRs, made architecture calls, and coordinated a team of about 7 engineers while still shipping my own work. It was a different kind of hard. I am glad it happened early.
