...
This was my first time integrating a large language model into a production API and my first time working with JSON-RPC 2.0. Both required reading actual specifications rather than following familiar patterns. That is a different kind of learning than building on top of well-documented frameworks.
