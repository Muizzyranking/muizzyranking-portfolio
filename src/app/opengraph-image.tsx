...
export default function OGImage() {
  return new ImageResponse(
    ...
    >
      ...
      >
        <defs>
          <pattern id="grid" width="48" height="48" patternUnits="userSpaceOnUse">
            <path d="M 48 0 L 0 0 0 48" fill="none" stroke="#1f1f1f" strokeWidth="1" />
          </pattern>
        </defs>
      ...
      >
        {["Python", "FastAPI", "Django", "Redis", "Docker", "→ AI/ML"].map((tag, i) => (
          <div
            key={tag}
            style={{
              fontFamily: "monospace",
              ...
              border: `1px ${i === 5 ? "solid" : "solid"} ${i === 5 ? "#2d5238" : "#2a2a2a"}`,
              borderRadius: "4px",
              padding: "5px 12px",
      ...
      <div
        style={{
          ...
          bottom: "0",
          width: "3px",
          background: "linear-gradient(to bottom, #4a7c59, #2d5238, transparent)",
        }}
      />
    </div>,
    {
